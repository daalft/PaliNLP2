...
public class OverwritingStrategy extends AbstractStrategy {
	...
	public List<ConstructedWord> apply (ILogInterface log, String lemma, AbstractStrategy main, List<JProperty> over, String... options)  {
		List<ConstructedWord> words = main.apply(log, lemma, options);
